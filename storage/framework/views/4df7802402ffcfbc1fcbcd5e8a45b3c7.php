<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
                <a href="<?php echo e(route('admin.users.export')); ?>" class="dropdown-item">
...
<?php echo $__env->make('base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH K:\Master IFRI\Stage\conceptic_user_mgmt\resources\views/auth/dashboard.blade.php ENDPATH**/ ?>